...
filenames=["./OK/%08d.tiff"%(i) for i in range(1,1501)]
filenames.extend(["./PLUSIEURS_VEHICULES/%08d.tiff"%(k) for k in range(1,1501)])
...
for image_path in filenames:
    ...
    if(file_counter%100==0):
        print("we have processed %d files out of 3000 files"%(file_counter))
