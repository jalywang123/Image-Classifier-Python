...
#Number of epochs
#Our batch generator generates (num_epoch*capacity) batches
#In order to assure that there is enough data for training
...
with tf.name_scope('Input-producer'): 
    ...
    #filename_one_validation_set_queue=tf.train.string_input_producer([tfrecords_validation_file],num_epochs=1)
    #final_validation_images,final_validation_labels=read_and_decode(filename_one_validation_set_queue,validation_batch,3000)
